	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">PCA</a>
			</div>
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li class="<?php echo Uri::segment(2) == '' ? 'active' : '' ?>">
						<?php echo Html::anchor('ahome', 'Our Attractions') ?>
					</li>

							<li class="<?php echo Uri::segment(2) == 'allattraction' ? 'active' : '' ?>">
								<?php echo Html::anchor('federation/allattraction', 'Travel Federation') ?>
							</li>
							<li class="<?php echo Uri::segment(2) == 'about' ? 'active' : '' ?>">
								<?php echo Html::anchor('ahome/about', 'About Us') ?>
							</li>
							<li class="<?php echo Uri::segment(2) == 'shopcart' ? 'active' : '' ?>">
								<?php echo Html::anchor('federation/shopcart', 'Shopping Cart') ?>
							</li>
				</ul>
